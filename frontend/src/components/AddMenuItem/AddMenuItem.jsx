...
const AddMenuItem = ({ onClose, onSave, secciones, itemToEdit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.precio || Number(formData.precio) <= 0) newErrors.precio = "Ingresa un precio válido";
    if (!formData.seccion) newErrors.seccion = "Selecciona una sección";

    const ingredientesLimpios = formData.ingredientes.filter(ing => ing.trim() !== '');
    if (ingredientesLimpios.length === 0) newErrors.ingredientes = "Agrega al menos un ingrediente";
      ...
      <div className={styles.modal}>
        ...
        <form onSubmit={handleSubmit} className={styles.form} noValidate>
          <div className={styles.grid}>
            <div className={styles.field}>
              ...
              <input 
                ...
                onChange={handleChange} className={errors.nombre ? styles.errorInput : ""} 
              />
            ...
            <div className={styles.field}>
              ...
              <input 
                ...
                onChange={handleChange} className={errors.precio ? styles.errorInput : ""} 
              />
            ...
            <div className={styles.selectWrapper}>
              <Select
                ...
                styles={{
                  ...
                  control: (base) => ({
                    ...base,
                    border: errors.seccion ? "2px solid #ef4444" : "2px solid #f2f2f2"
                  })
                }}
              />
            </div>
          ...
          <div className={styles.field}>
              ...
              {formData.ingredientes.map((ing, index) => (
                <div key={index} className={styles.ingredientRow}>
                  <input
                    ...
                    autoFocus={index === formData.ingredientes.length - 1 && index !== 0}
                  />
            ...
            <button type="button" className={styles.addIngBtn} onClick={addIngredient}>+ Agregar ingrediente</button>
          </div>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.fileInput}>
              ...
              <span>{formData.imagen ? formData.imagen.name : isEditing ? "Dejar actual" : "Subir foto"}</span>
            </div>
